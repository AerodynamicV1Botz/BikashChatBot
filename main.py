...
API_ID = os.environ.get("API_ID", "13417489") 
API_HASH = os.environ.get("API_HASH", "0cca62fb8f00b5ed2ca858561dfbc9f6") 
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5417620546:AAEYvaacYYC8r26uJO3V2DwiOzMzdJX3bpE") 
MONGO_URL = os.environ.get("MONGO_URL", "mongodb+srv://bikash:bikash@bikashop.mal5rvb.mongodb.net/?retryWrites=true&w=majority")
...
async def start_(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/5ffabc6efe879f4b2b92c.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
...
┏━━━━━━━━━━━━━━━━━┓
┣❥︎ ♕︎𝐎𝐰𝐧𝐞𝐫♕︎   » [𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞](https://t.me/bikashHalder)
┣❥︎ 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 ➪ » [𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞](https://t.me/BikashGedgetsTech)
            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ 𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 ❱ ➕", url=f"https://t.me/BikashRobot?startgroup=true")
                ]
...
@bot.on_message(filters.command(["/start", f"start@BikashRobot", "/alive", ".alive", "#bikash", "#aditya"]) & filters.group & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/5ffabc6efe879f4b2b92c.jpg",
        caption=f"""💥 𝐇𝐢! 𝐈'𝐦 𝐀 𝐀𝐝𝐯𝐚𝐧𝐜𝐞 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭 🌷.\n\n📌 𝐌𝐲 𝐍𝐚𝐦𝐞 𝐈𝐬 𝐕 𝐁𝐨𝐭 🌷 𝐅𝐨𝐫𝐦 𝐈𝐧𝐝𝐢𝐚 🇮🇳 \n\n🌷 𝐈'𝐦 𝐀 𝐀𝐫𝐭𝐢𝐟𝐢𝐜𝐢𝐚𝐥 𝐈𝐧𝐭𝐞𝐥𝐥𝐢𝐠𝐞𝐧𝐜𝐞 🌷\n\n𝐀𝐧𝐲 𝐏𝐫𝐨𝐛𝐥𝐞𝐦 𝐓𝐨 𝐑𝐞𝐩𝐨𝐫𝐭 @Bgt_Chat 🥀\n\n𝐔𝐩𝐝𝐚𝐭𝐞𝐬 @BikashGedgetsTech 🌷\n\n /chatbot - [on|off]""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
